												...
												<ul class="mb0">
													<li class="list-inline-item " id="Create-Assignment">
														<form class="form-group"  method="get" action="#">
																...
																<button type="button" class="btn btn-sm pop-login" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">Post &nbsp <span class="icofont-ui-add"></span></button>
														</form>
													</li>
												</ul>
											</div>
