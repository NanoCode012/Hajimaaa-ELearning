                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="dashboard_container">
                                            ...
                                            <ul class="mb0">
                                                ...
                                                <li class="list-inline-item">
                                                    ...
                                                    <button type="button" class="btn btn-sm pop-login"
                                                        ...
                                                        data-whatever="@getbootstrap">Post  &nbsp <span class="icofont-ui-add"> </span></button>
                                    ...
                                    <div class="dashboard_container_body">
                                        ...
                                        <!-- Single Course -->
                                            <?php
                                             $stmt = $db_r->query(' SELECT p.post_id, post_type, class_id,title,description,time_created,assignment_id,due_date FROM posts p LEFT JOIN Assignments a ON a.post_id=p.post_id WHERE class_id=1 ORDER BY time_created ');
                                            ...
                                            <div class="dashboard_single_course_caption">
                                                ...
                                                <div class="dashboard_single_course_progress">
                                                    ...
                                                    <div class="ass-buttons">
                                                        ...
                                                        <?php /*<a href='?p=Delete_post&post_id=<?php echo $row['post_id']?>&post_type=<?php echo $row['post_type']?>' class="btn btn-theme-2"> Delete</a>*/ ?>
                                                     </div>
                                                    ...
                                                    <div class="dashboard_single_course_progress_2">
                                                        <ul class="m-0">
                                                            <li class="list-inline-item"><i class="ti-user mr-1"></i><?php //echo $Assigned ?>
                                                                Assigned</li>
                                                            <li class="list-inline-item"><i class="far fa-file mr-1"></i><?php //echo $Files ?> Files</li>
                                                        </ul>
                                                    </div>
                                                    <?php } ?>
