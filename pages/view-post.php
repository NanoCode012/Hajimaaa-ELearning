                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 pt-4 pb-4">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="?p=class-main"><span class="ti-angle-left"> Back </a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
...
<br><img src="assets/img/trash.svg" width="20" height="20" style="float:right">
									...
									<div class="reviews-comments-item">
										...
										<div class="reviews-comments-item-text">
											<h4><a href="#">Rita Chawla</a><span class="reviews-comments-item-date"><i class="ti-calendar theme-cl"></i>2 Nov 2019</span></h4>
										...
										<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12">
												<div class="form-group">
													...
													<textarea class="form-control ht-140" placeholder="Enter the comment"></textarea>
												</div>
											</div>
