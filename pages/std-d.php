                    ...
                    <div class="ed_detail_wrap">
                      ...
                      <div class="ed_header_caption">
                        ...
                        <ul>
                          ...
                          <li><i class="ti-user"></i>72 Student Enrolled</li>
                        </ul>
                      </div>
              ...
              <div class="dashboard_container">
                <div class="dashboard_container_header">
                          ...
                          <div class="edu_cat_data">
                            <h4 class="edu_title">Student's Name</h4>
                            <ul class="meta">
								...
								<div id="accordionExample" class="accordion shadow circullum">
									...
									<div class="card">
									  <div id="headingOne" class="card-header bg-white shadow-sm border-0">
										<h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="d-block position-relative text-dark collapsible-link py-2">Lab04: How to design a circuit?</a></h6>
									  </div>
									  <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample" class="collapse show">
										<div class="card-body pl-3 pr-3">
											<ul class="lectures_lists">
												<li><div class="lectures_lists_title"><i class="ti-files"></i></div>StudentID.pdf</li>
												<li><div class="lectures_lists_title"><i class="ti-gallery"></i></div>Circuit.png</li>
												<li><div class="lectures_lists_title"><i class="ti-video-clapper"></i></div>Illustration.mov</li>
											</ul>
                    </div>
                                                                <div class="edu_wraper">
                                                                  ...
                                                                  <div class="form-group">
                                                                                        <input type="email" class="form-controll" placeholder="  Input scores here" required="required">
                                                                                                                              ...
                                                                                                                              <div class="form-group">
                                                                                                                                ...
                                                                                                                                <h4 class="edu_title">Comment</h4>
                                                                                                                                  <div class="row">
                                                                                                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                                                                      <div class="form-group">
                                                                                                                                          <textarea class="form-control ht-140" placeholder="Add Private Comment"></textarea>
                                                                                                                                      </div>
                                                                                                                                  	</div>
                                                                                                                                  <div class="col-lg-12 col-md-12 col-sm-12">
                                                                                                                                  <div class="form-group">
