                                    ...
                                    <div class="card">
                                        <div id="headingOne" class="card-header bg-white shadow-sm border-0">
                                            <h6 class="mb-0 accordion_title"><a href="#" data-toggle="collapse"
                                                    ...
                                                    class="d-block position-relative text-dark collapsible-link py-2">Lab04:
                                                    How to design a circuit?</a></h6>
                                        </div>
                                        <div id="collapseOne" aria-labelledby="headingOne"
                                            ...
                                            <div class="card-body pl-3 pr-3">
                                                <ul class="lectures_lists">
                                                    <li>
                                                        <div class="lectures_lists_title"><i class="ti-files"></i></div>
                                                        StudentID.pdf
                                                    </li>
                                                    <li>
                                                        <div class="lectures_lists_title"><i class="ti-gallery"></i>
                                                        </div>Circuit.png
                                                    </li>
                                                    <li>
                                                        <div class="lectures_lists_title"><i
                                                                class="ti-video-clapper"></i></div>Illustration.mov
                                                    </li>
                                                </ul>
                                            </div>
