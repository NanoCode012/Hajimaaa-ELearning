                  ...
                  <div class="col-lg-8 col-md-7">
                    <div class="ed_detail_wrap">
                      ...
                      <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="button"><h1 class="ed_title">40</h1><span class="ed_title">Done</span></button>
                    ...
                    <div class="input-group-append">
                      ...
                      <h1 class="theme-cl">34</h1><span class="theme-cl">NotDone</span>
                    </div>
                  </div>
                  </div>
