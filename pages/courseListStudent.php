          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
              ...
              <div class="dashboard_container">
                ...
                <?php
                $sql = "SELECT class_name, class_code, class_instructor,class_des,class_count,class_ass from class where class_id IN (SELECT class_id FROM class_enrolled WHERE user_id =1)";
