                                            ...
                                            <div class="submit-section">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            placeholder="Course Code" name="course_code" required>
                                                    </div>
                                            ...
                                            <div class="submit-section">
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <select class="form-control styled-select" multiple
                                                            name="categorySelect[]" required>
                                                            <option value="Science">Science</option>
                                                            <option value="Math">Math</option>
                                                            <option value="Computer Science">Computer Science</option>
                                                            <option value="Programming Language">Programming Language
                                                            </option>
                                                            <option value="Web Development">Web Development</option>
                                                            <option value="Mobile Development">Mobile Development
                                                            </option>
                                                            ...
                                                            <option value="Business and Management">Business and
                                                                Management</option>
